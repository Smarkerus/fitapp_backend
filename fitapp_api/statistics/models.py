...
class StatisticActivity(BaseModel):
	...
	distance: float = Field(ge=0, description="Dystans w m")
	time: float = Field(ge=0, description="Czas w sekundach")
...
class StatisticsResponse(BaseModel):
	...
	total_distance: float = Field(ge=0, description="Całkowity dystans w m")
